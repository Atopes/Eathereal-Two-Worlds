...
public class RangedEnemyController : MonoBehaviour
{
    ...
    public GameObject enemeyProjectilePrefab;
    ...
    private Vector3 seekDistance = new Vector3(8f, 0);
    ...
    void Update()
    {
        if (enemyCollision.IsTouching(playerCollision))
        ...
        { //Checks if the enemy is touching a wall,damageableObject or platform
            ...
            { // Should the enemy be falling it wont start spinning xd
    ...
    private void Flip()
    {
        ...
        seekDistance = new Vector3(-seekDistance.x, 0);
    }
